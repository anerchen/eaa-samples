...
class ClassMapCache {
	...
	private Class<? extends LockedActiveRecord> baseClass;
	...
	public ClassMapCache( Class<? extends LockedActiveRecord> baseClass ) {
	...
	public String getIdentityColumnOfHasManyFromListClass( Class<? extends LockedActiveRecord> child ) {
	...
	public Class<? extends LockedActiveRecord> getBaseClass() {
		return baseClass;
	}
