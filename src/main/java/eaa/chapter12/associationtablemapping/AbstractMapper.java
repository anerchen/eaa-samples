...
public abstract class AbstractMapper<E extends DomainObject> {
	...
	protected long findNextId( Connection c ) throws SQLException {
		return KeyGenerator.getNextId( c, table() );
	}
	...
	protected abstract void postInsert( Connection c, E subject ) throws SQLException;
	protected abstract void preDelete( Connection c, E subject ) throws SQLException;
