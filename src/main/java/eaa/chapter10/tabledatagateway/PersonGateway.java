...
public class PersonGateway {
  ...
  public static ResultSet findById(long personId) {
    ...
    try {
      ...
      PreparedStatement stmt = c
          .prepareStatement("SELECT id,first_name,last_name,address,city,state,zip_code FROM people where id=?");
  ...
  public static ResultSet findByLastName(String lastName) {
    ...
    try {
      ...
      PreparedStatement stmt = c
          .prepareStatement("SELECT id,first_name,last_name,address,city,state,zip_code FROM people where last_name = ?");
  ...
  public static void insertPerson(String first_name, String last_name, String address, String city,
    ...
    try {
      ...
      stmt = c
          .prepareStatement("INSERT INTO people (id,first_name,last_name,address,city,state,zip_code) "
              + " VALUES (?,?,?,?,?,?,?) ");
